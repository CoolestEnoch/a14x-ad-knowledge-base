# Focals-conv-mm(SAM融合，小波模块，点云特征图像特征fusion模块) 实现人：张国欣&刘林

代码路径: 耕轮机器(4*A800(80G)) ：/data/zhanggl/focalsconv-mm

conda 环境: 耕轮机器 focalsconvmm_env

sam_encoder的预训练权重: /data/zhanggl/focalsconv-mm/checkpoints/sam_image_encoder_b.pth

mobilesam_encoder的预训练权重：/data/zhanggl/focalsconv-mm/OpenPCDet/checkpoints/mobile_image_encoder.pt

fast_sam的预训练权重：/data/zhanggl/focalsconv-mm/OpenPCDet/checkpoints/FastSAM.pt

代码库位置：[https://gitee.com/liulliul/focalconvsamfusion](https://gitee.com/liulliul/focalconvsamfusion)
...
### 添加小波模块
> 1./data/zhanggl/focalsconv-mm/OpenPCDet/pcdet/models/backbones_3d/focal_sparse_conv/wavevit.py
>
> 2./data/zhanggl/focalsconv-mm/OpenPCDet/pcdet/models/backbones_3d/focal_sparse_conv/torch_wavelet.py一些工具类
>
...
/data/zhanggl/focalsconv-mm/OpenPCDet/pcdet/datasets/kitti/kitti_dataset.py 542-545行
...
/data/zhanggl/focalsconv-mm/OpenPCDet/pcdet/datasets/dataset.py 164-168行
...
2. **添加该模块网络结构中需要修改的地方**
       ...
       新添加两个函数/data/zhanggl/focalsconv-        mm/OpenPCDet/pcdet/models/backbones_3d/focal_sparse_conv/focal_sparse_conv.py
...
### 添加fusion模块
/data/zhanggl/focalsconv-mm/OpenPCDet/pcdet/models/backbones_3d/focal_sparse_conv/utils.py
...
> 更新: 2023-08-23 09:07:00  
> 原文: <https://3dcv.yuque.com/org-wiki-3dcv-mm1l0t/ysgfp9/ocpqt9txol8dkdgd>