# Transfusion（SAM融合，小波相关模块）实现人：刘林

代码库位置：[https://gitee.com/liulliul/samtransfusion.git](https://gitee.com/liulliul/samtransfusion.git)

模型权重：链接：[https://pan.baidu.com/s/1r7J50b-A9P4iuWfl6-FAaw?pwd=8888](https://pan.baidu.com/s/1r7J50b-A9P4iuWfl6-FAaw?pwd=8888) 

fastsam的融合版本并未和tranfusion的权重融合在一起，而是训练时单独加载进来故没有fusion_voxel0075_fastsam.pth文件，而有fusion_voxel0075_SAM.pth和fusion_voxel0075_mobilesam.pth文件

说明：transfusion代码中并未添加focals-conv-mm代码中的fusion模块
...
需要注意相关config文件在/data/zhanggl/sda/dxg/bev/focalsconv-mm/Transfusion_SAM/work_dirs文件夹下。



> 更新: 2023-09-06 10:09:40  
> 原文: <https://3dcv.yuque.com/org-wiki-3dcv-mm1l0t/ysgfp9/deg9tnhcrcq7ief6>