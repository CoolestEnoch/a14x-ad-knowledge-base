...
## **——kitti代码实现：**
用下面的代码 替换掉 kitti_dataset.py（OpenPCDet_wei/pcdet/datasets/kitti/kitti_dataset.py）中的代码
...
## **——**验证模型在不同距离的表现-nus
/home/public_C/liulin/anaconda3/envs/OpenPCDet/lib/python3.8/site-packages/nuscenes/eval/common/loaders.py

找到该路径下的文件，个人建议离线安装nus包，这样修改起来非常方便替换下面的函数
...
def filter_eval_boxes(nusc: NuScenes,
    ...
    for ind, sample_token in enumerate(eval_boxes.sample_tokens):
        ...
        eval_boxes.boxes[sample_token] = [box for box in eval_boxes[sample_token] if
                                          box.ego_dist < det_range[1] and box.ego_dist >= det_range[0]]
...
> 更新: 2025-01-08 16:16:49  
> 原文: <https://3dcv.yuque.com/org-wiki-3dcv-mm1l0t/ysgfp9/ydit0mp5vwsdz2po_onxqx1>